...
/*:
 ...
 +, == 또는 ->와 같은 이항 연산자 뒤 공백이 있어야 함. 또한 ( 뒤 와 ) 앞에는 공백이 없어야 함.
...
/*: 1.8
 ...
 Xcode의 들여쓰기 스타일 사용 (예. CTRL-I를 눌렀을때 코드 변화가 없어야 함). 여러 줄에 걸쳐있는 함수를 선언 할 때 Xcode가 기본값으로 사용되는 구문을 사용.
...
/*:
 ...
 다중 행의 조건 비교의 경우 지역 상수 등을 가능하면 사용한다.
